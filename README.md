...
[![Deploy](https://www.linkpicture.com/q/heroku.jpg)](https://heroku.com/deploy?template=https://github.com/Devu32/pikachu.git)
     </div>
<br>
<br >
...
```js
SETUP
$ git clone https://github.com/Devu32/pikachu
$ cd pikachu
$ chmod +x *
$ npm i
$ node qr.js
